          ...
          {caseStudies.map((study, index) => (
            <SwiperSlide key={index}>
              <div className="row align-items-center">
                <div
                  className="col-12 col-sm-12 col-md-12 col-lg-5 offset-lg-1 order-lg-1 wow fadeInUp"
                  data-wow-delay="0.1s"
                >
                ...
                <div
                  className="col-12 col-sm-12 col-md-12 col-lg-6 order-lg-12 wow fadeInUp"
                  data-wow-delay="0.1s"
                >
                          ...
                          {study.points.map((point, index) => (
                            <li key={index}>
                              <span>
                                <img
                                  className="icon"
                                  src={`${process.env.PUBLIC_URL}/images/icons/${point.icon}`}
                                  alt=""
                                />
                              </span>{" "}
                              {point.description}
